...
- **OAuth 2.1 Authentication**: Connect to protected MCP servers with OAuth authentication (supports Dynamic Client Registration and RFC 8707 Resource Indicators).
