...
// mcp-debug binaries, one per platform, each next to its cosign Sigstore bundle.
const githubRepoSlug = "giantswarm/mcp-debug"
...
func newSelfUpdateCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "self-update",
		Short: "Update mcp-debug to the latest version",
		Long: `Checks for the latest release of mcp-debug on GitHub and
